          ...
          <div class="row slide-margin">
            <div class="col-sm-12">
              ...
              <div class="carousel-content">
                <h1>Selamat Datang di synSoft.web.id</h1>
                <h2>Jasa Pembuatan Website dan Installasi Jaringan</h2>
				</div>
            </div>
          </div>
        </div>
      ...
      <div class="item" style="background-image: url(images/slider/bg2.jpg)">
        <div class="container">
          <div class="row slide-margin">
            <div class="col-sm-12">
              <div class="carousel-content">
                <h1>Anda Butuh Website dan Jaringan ?</h1>
                <h2>Silahkan Hubungi Kami +6281515176779</h2>
	  ...
	  <div class="item" style="background-image: url(images/slider/bg2.jpg)">
        <div class="container">
          <div class="row slide-margin">
            <div class="col-sm-12">
              <div class="carousel-content">
                <h1>Anda Butuh Program Skripsi ?</h1>
                <h2>Silahkan Hubungi Kami +6281515176779</h2>
                <a class="btn-slide" href="about-us.html">Read More</a> </div>
            </div>
          </div>
